...
N = 15     # Number of basis functions to use in Rayleigh-Ritz method (total number of coefficients is 3*N)
...
#aileron.plotv()             # Plot the deflections in y-direction, its derivative, the bending moment about the z-axis, and the shear force in y.
            # Plot the deflections in z-direction, its derivative, the bending moment about the y-axis, and the shear force in z.
...
defv, defw, twist = aileron.eval(x)       # Compute the three deflections
dvdx, dwdx, dtwistd = aileron.fdeval(x)     # Compute their their first order derivative
...
# Compute the loading
sheary = aileron.Sy(x)               # Compute the shear force in y
shearz = aileron.Sz(x)               # Compute the shear force in z
Momy = aileron.My(x)               # Compute the moment around the y-axis
Momz = aileron.Mz(x)               # Compute the moment around the z-axis
torque = aileron.T(x)                # Compute the torque
disttorque = aileron.tau(x)              # Compute the distributed torque
